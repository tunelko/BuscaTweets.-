...
LUNGO.View.Template.List = (function(lng, undefined) {
    ...
    var _createScroll = function() {
       ...
       // @ToDo >> method to pulldown
        lng.dom("#"+_config.container_id).prepend('<div id="pullDown"><span class="pullDownIcon"></span><span class="pullDownLabel"></span></div>');  
        onTouchEnd: $$('.pullDownLabel').html('Arrastra hacia abajo para actualizar ...');  
    };
